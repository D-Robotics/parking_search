...
#ifndef PARKING_STRATEGY_NODE_H
#define PARKING_STRATEGY_NODE_H
...
class ParkingSearchNode : public rclcpp::Node {
 public:
  ParkingSearchNode(const std::string &node_name, SmartCbType smart_cb);
 ...
 private:
  ...
  std::string ai_msg_sub_topic_name_ = "/ai_msg_parking_perception";
